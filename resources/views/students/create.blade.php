<x-company-panel-layout :company="$company">
    <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight mb-6">
        Nuevo Alumno para: {{ $company->name }}
    </h2>
            ...
            <form method="POST" action="{{ route('students.store') }}">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input id="name" name="name" type="text" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 dark:bg-gray-900 dark:border-gray-600" value="{{ old('name') }}" required />
                    </div>

                    <!-- CURP -->
                    <div>
                        <label for="curp" class="block font-medium text-sm text-gray-700 dark:text-gray-300">CURP*</label>
                        <input id="curp" name="curp" type="text" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 dark:bg-gray-900 dark:border-gray-600" value="{{ old('curp') }}" required />
                    </div>

                    <!-- RVOE -->
                    <div>
                        <label for="aut_rvoe" class="block font-medium text-sm text-gray-700 dark:text-gray-300">Aut. RVOE*</label>
                        <input id="aut_rvoe" name="aut_rvoe" type="text" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 dark:bg-gray-900 dark:border-gray-600" value="{{ old('aut_rvoe') }}" required />
                    </div>
