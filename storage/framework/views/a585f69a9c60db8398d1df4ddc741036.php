...
<?php $component->withAttributes(['company' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($company)]); ?>
    <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight mb-6">
        Editando Alumno: <?php echo e($student->name); ?>
            ...
            <form method="POST" action="<?php echo e(route('students.update', $student)); ?>">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input id="name" name="name" type="text" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 dark:bg-gray-900 dark:border-gray-600" value="<?php echo e(old('name', $student->name)); ?>" required />
                    </div>

                    <!-- CURP -->
                    <div>
                        <label for="curp" class="block font-medium text-sm text-gray-700 dark:text-gray-300">CURP*</label>
                        <input id="curp" name="curp" type="text" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 dark:bg-gray-900 dark:border-gray-600" value="<?php echo e(old('curp', $student->curp)); ?>" required />
                    </div>

                    <!-- RVOE -->
                    <div>
                        <label for="aut_rvoe" class="block font-medium text-sm text-gray-700 dark:text-gray-300">Aut. RVOE*</label>
                        <input id="aut_rvoe" name="aut_rvoe" type="text" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 dark:bg-gray-900 dark:border-gray-600" value="<?php echo e(old('aut_rvoe', $student->aut_rvoe)); ?>" required />
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <select id="education_level" name="education_level" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 dark:bg-gray-900 dark:border-gray-600" required>
                            ...
                            <?php $__currentLoopData = $educationLevels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $level): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($level); ?>" <?php if(old('education_level', $student->education_level) == $level): echo 'selected'; endif; ?>><?php echo e($level); ?></option>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\facturameorg\resources\views/students/edit.blade.php ENDPATH**/ ?>