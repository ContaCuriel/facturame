...
| file here. This allows us to redirect all requests to this file so
| that any rendered content can be displayed instead of breaking.
|
*/
...
| browser's client. We'll just need to specify the kernel class.
|
*/
